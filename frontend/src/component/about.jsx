...
// import profileImg from "../assets/profile.jpg"; // tumhare image path ke according change karo
  ...
  return (
    ...
    >
      ...
      <div className="mt-10 flex flex-col lg:flex-row items-center lg:items-start gap-10 max-w-6xl w-full">
        {/* Profile Image */}
        <div className="w-[400px] h-[400px] object-cover rounded-2xl shadow-md bg-slate-900 mr-14"></div>

        {/* Right Content */}
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-xl px-28">
          {/* Cards */}
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            ...
            <div className="bg-white border rounded-xl flex flex-col items-center p-4 shadow-sm w-[180px]">
              ...
              <p className="text-sm text-gray-500">48+ Projects</p>
            </div>
